...
namespace Pexels.Areas.Control.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Category1,Image")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Category1,Image")] Category category)
        {
            if (ModelState.IsValid)
            {

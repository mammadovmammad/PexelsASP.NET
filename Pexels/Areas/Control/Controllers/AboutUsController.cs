...
namespace Pexels.Areas.Control.Controllers
{
    public class AboutUsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Content,Icon")] AboutUs aboutUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Content,Icon")] AboutUs aboutUs)
        {
            if (ModelState.IsValid)
            {
